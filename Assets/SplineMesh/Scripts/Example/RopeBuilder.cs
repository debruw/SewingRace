    ...
    public class RopeBuilder : MonoBehaviour {
        ...
        private void Update() {
            ...
            if (Application.isPlaying) {
                ...
                {
                    translation = new Vector3(Input.GetAxis("Mouse X"), 0, 0) * Time.deltaTime * 20;

                    firstSegment.transform.Translate(translation, Space.World);
                    firstSegment.transform.localPosition += new Vector3(0, 0, Time.deltaTime * 5);
                }
