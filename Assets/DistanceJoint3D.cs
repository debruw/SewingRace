...
public class DistanceJoint3D : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        Rigidbody.velocity = new Vector3(Rigidbody.velocity.x, Mathf.Clamp(Rigidbody.velocity.y, float.MinValue, -1), Mathf.Clamp(Rigidbody.velocity.z, float.MinValue, -2));
        var offset = transform.position - ConnectedRigidbody.position;
        transform.up = offset;
    }
}
